...
class SalariedEmployee extends Employee {
    ...
    public SalariedEmployee(String first, String last, String ssn, double salary) {
        ...
        if (salary < 0.0) {
            throw new IllegalArgumentException("Weekly salary must be non-negative");
        }
...
public class PayrollSystemDemo {
    public static void main(String[] args) {
        ...
        payableList.add(new SalariedEmployee("John", "Smith", "123-45-6789", 800.0));
        payableList.add(new HourlyEmployee("Karen", "Price", "987-65-4321", 16.75, 40));
        payableList.add(new CommissionEmployee("Sue", "Jones", "555-55-5555", 10000, 0.06));
        payableList.add(new BasePlusCommissionEmployee("Bob", "Wilson", "444-44-4444", 5000, 0.1, 300));
        payableList.add(new Invoice("A123B", "Widget A", 10, 29.99));
        payableList.add(new Invoice("C456D", "Widget B", 2, 19.99));
